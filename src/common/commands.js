import { readdir, readFile, stat, writeFile, rename as renameFS, unlink } from 'node:fs/promises';
...
export const list = async (path) => {
  ...
  console.table([...folderNames, ...fileNames /*...linksNames*/], ['name', 'type']);
};
...
export const rename = async ({ sourceFilePath, newFileName, targetDirectoryName }) => {
  const isInputFile = await isFile(sourceFilePath);
